...
public final class BaritoneControlScreen extends Screen {
    ...
    @Override protected void init() {
        ...
        addRenderableWidget(Button.builder(Component.literal("World pick"),b->Minecraft.getInstance().gui.setScreen(new GuiClick())).bounds(c+50,68,90,20).build());
    ...
    @Override public void extractRenderState(GuiGraphicsExtractor g,int mx,int my,float pt){ super.extractRenderState(g,mx,my,pt); }
}
